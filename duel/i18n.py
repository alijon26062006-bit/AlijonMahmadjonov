...
STRINGS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "ui.game.soon": "скоро",
        "ui.game.five": "Пять в ряд",
        "ui.game.five.hint": "Крестики-нолики: пять подряд",
        "ui.five.title": "ПЯТЬ В РЯД",
        "ui.five.hint": "Пять своих подряд — по строке, столбцу или косой",
        "ui.five.your_turn": "Твой ход",
        "ui.five.opp_turn": "Ход соперника",
        "ui.five.not_your_turn": "Сейчас ходит соперник — подожди",
        "ui.five.busy": "Эта клетка уже занята",
        "ui.five.you": "ты",
        "ui.five.opp": "он",
        "ui.five.win.line": "Ты выстроил пять подряд",
        "ui.five.loss.line": "Соперник выстроил пять подряд",
        "ui.five.draw.full": "Поле кончилось, пятёрки нет — ничья",
        "ui.five.win.time": "Время вышло — твоя линия длиннее",
        "ui.five.loss.time": "Время вышло — линия соперника длиннее",
        "ui.five.draw.time": "Время вышло — линии равны",
        "ui.five.win.idle": "Соперник перестал ходить",
        "ui.five.loss.idle": "Ты пропустил три хода подряд",
        "ui.five.win.left": "Соперник не вернулся",
        "ui.five.loss.left": "Ты вышел из партии",
        "ui.result.moves": "Ходов",
        "ui.result.line": "Самая длинная линия",
        ...
        "bot.rules.text": (
            ...
            "✖️ Пять в ряд — крестики-нолики на большом поле\n"
            "• Поле девять на девять. Ходите по очереди, первому достаются крестики.\n"
        ...
        "bot.game.five": "Пять в ряд",
        "bot.duel.sea": "до победы · потопи флот",
        "bot.duel.five": "до победы · пять подряд",
    ...
    "tg": {
        ...
        "ui.game.five": "Панҷ дар қатор",
        "ui.game.five.hint": "Чорчӯба-сифр: панҷто пай дар пай",
        "ui.five.title": "ПАНҶ ДАР ҚАТОР",
        "ui.five.hint": "Панҷ аломати худро пай дар пай — сатр, сутун ё каҷ",
        "ui.five.your_turn": "Навбати ту",
        "ui.five.opp_turn": "Навбати рақиб",
        "ui.five.not_your_turn": "Ҳоло рақиб мегузорад — интизор шав",
        "ui.five.busy": "Ин катак аллакай банд аст",
        "ui.five.you": "ту",
        "ui.five.opp": "ӯ",
        "ui.five.win.line": "Ту панҷтоеро пай дар пай сохтӣ",
        "ui.five.loss.line": "Рақиб панҷтоеро пай дар пай сохт",
        "ui.five.draw.full": "Майдон тамом шуд, панҷто нашуд — баробар",
        "ui.five.win.time": "Вақт тамом — хати ту дарозтар",
        "ui.five.loss.time": "Вақт тамом — хати рақиб дарозтар",
        "ui.five.draw.time": "Вақт тамом — хатҳо баробаранд",
        "ui.five.win.idle": "Рақиб бозиро партофт",
        "ui.five.loss.idle": "Ту се навбатро пай дар пай гузаронидӣ",
        "ui.five.win.left": "Рақиб барнагашт",
        "ui.five.loss.left": "Ту аз бозӣ баромадӣ",
        "ui.result.moves": "Ҳаракатҳо",
        "ui.result.line": "Дарозтарин хат",
        ...
        "bot.rules.text": (
            ...
            "✖️ Панҷ дар қатор — чорчӯба-сифр дар майдони калон\n"
            "• Майдон нӯҳ ба нӯҳ. Навбат ба навбат мегузоред, аввалин чорчӯба мегирад.\n"
            "• Панҷ аломати худро пай дар пай — сатр, сутун ё каҷ — ғалаба.\n"
            "• Ба ҳар навбат ним дақиқа. Се навбати пай дар пай гузаронда — мағлубият.\n\n"
        ...
        "bot.game.five": "Панҷ дар қатор",
        "bot.duel.sea": "то ғалаба · флотро ғарқ кун",
        "bot.duel.five": "то ғалаба · панҷто пай дар пай",
