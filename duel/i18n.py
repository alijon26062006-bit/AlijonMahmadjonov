...
STRINGS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "ui.auth.no_data": "Telegram не передал данные о тебе. Открой игру "
                           "кнопкой в боте, а не по ссылке",
    ...
    "tg": {
        ...
        "ui.auth.no_data": "Telegram маълумоти туро нафиристод. Бозиро бо "
                           "тугмаи бот кушо, на бо истинод",
