...
TOOLS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "input_schema": {
            "type": "object",
            "properties": {
                "when": dict(_DATE, description="Дата срабатывания (ГГГГ-ММ-ДД). Обязательно."),
                "time": {
                    "type": "string",
                    "description": (
                        "Время в формате ЧЧ:ММ. «В три часа дня» = 15:00, «утром» = 09:00, "
                        "«в обед» = 13:00, «вечером» = 19:00. Если время не прозвучало — "
                        "не заполняй, подставится время по умолчанию."
                    ),
                },
