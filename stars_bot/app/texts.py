...
_RAW["ORDER_PROMO_ASK"] = (
    "[[promo]] <b>Промокод</b>\n"
    f"<code>{LINE}</code>\n\n"
    "<blockquote>Рамзро нависед. Промокоди тахфиф нархи ҳамин фармоишро "
    "кам мекунад, промокоди баланс маблағро ба ҳисоб мегузаронад.</blockquote>"
)
...
_RAW["PROMO_ASK"] = (
    "[[promo]] <b>Промокод</b>\n\n"
    "<blockquote>Рамзро нависед.\n\n"
    "Промокоди баланс — маблағ дарҳол ба ҳисоб мегузарад.\n"
    "Промокоди тахфиф — нигоҳ дошта мешавад ва ба хариди навбатӣ "
    "худ ба худ татбиқ мешавад.</blockquote>"
)

_RAW["PROMO_SAVED"] = (
    "[[party]] <b>Промокод нигоҳ дошта шуд</b>\n\n"
    "├ Тахфиф: <b>{percent}%</b>\n"
    "└ Ба хариди навбатӣ худ ба худ татбиқ мешавад\n\n"
    "<blockquote>Як бор кор мекунад. Нархи камшударо ҳангоми тасдиқи "
    "харид мебинед.</blockquote>"
)

_RAW["PROMO_GONE"] = "Промокод дигар амал намекунад — нарх бе тахфиф нишон дода шуд."
...
PROMO_ERRORS = {
    "not_found": "[[fail]] Чунин промокод вуҷуд надорад.",
    "already_used": "[[fail]] Шумо ин промокодро аллакай истифода бурдаед.",
    "in_use": (
        "[[fail]] Ин промокод аллакай дар фармоиши дигари шумост, ки ҳоло "
        "иҷро мешавад."
    ),
    "exhausted": "[[fail]] Ҳадди истифодаи ин промокод тамом шуд.",
    "not_for_balance": (
        "[[fail]] Ин промокоди <b>тахфиф</b> аст, на пуркунии баланс.\n\n"
        "<blockquote>Онро ҳангоми харид ворид кунед — дар қадами тасдиқ "
        "тугмаи «Промокод» ҳаст.</blockquote>"
    ),
    "not_for_order": (
        "[[fail]] Ин промокоди <b>пуркунии баланс</b> аст, на тахфиф.\n\n"
        "<blockquote>Онро дар профил фаъол кунед — маблағ ба ҳисоб "
        "мегузарад.</blockquote>"
    ),
}
