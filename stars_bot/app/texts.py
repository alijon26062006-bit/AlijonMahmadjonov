...
_RAW["DEPOSIT_RU_HOW"] = (
    ...
    f"<code>{LINE}</code>\n\n"
    "Переведите <b>любую сумму</b> со Сбербанка или Тинькофф по этим "
    "реквизитам:\n\n"
    "<code>{card}</code>\n"
    "{holder}{bank}"
    "<blockquote>[[warn]] Банк пересчитает рубли в сомони сам. "
    "В вашем чеке будет написана <b>сумма в сомони, с копейками</b> — "
    "например <code>107.43</code>.\n\n"
    "Эти копейки и есть ваш опознавательный знак: такой суммы прямо "
    "сейчас больше ни у кого нет. По ней бот найдёт ваш перевод "
    "сам.</blockquote>\n\n"
    "<i>Перевели — нажмите «Я отправил» и назовите сумму из чека</i>"
)

_RAW["DEPOSIT_RU_ASK"] = (
    "🇷🇺 <b>Сумма из чека</b>\n"
    f"<code>{LINE}</code>\n\n"
    "Откройте чек Сбербанка и найдите сумму <b>в сомони</b> — ту, что "
    "получил получатель.\n\n"
    "<blockquote>[[warn]] Перепишите её <b>точно, вместе с копейками</b>: "
    "<code>107.43</code>, а не <code>107</code>.\n\n"
