...
_RAW["GAME_BAD_ID"] = (
    "[[fail]] <b>Игрок не найден</b>\n\n"
    "<blockquote>ID <code>{player}</code> не найден в выбранном регионе.\n\n"
    "Две причины, обе легко проверить:\n"
    "├ <b>не тот регион</b> — аккаунт живёт на своём сервере;\n"
    "└ <b>опечатка в ID</b> — проверьте каждую цифру.\n\n"
    "Пришлите ID ещё раз или смените регион.</blockquote>"
)
