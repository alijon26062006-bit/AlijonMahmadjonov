...
_RAW["DEPOSIT_ASK_RECEIPT"] = (
    "📸 <b>Пришлите чек</b>\n"
    f"<code>{LINE}</code>\n\n"
    "Отправьте сюда скриншот чека — одним сообщением.\n\n"
    "<blockquote>[[ok]] Баланс на <b>{amount}</b> пополнится <b>сам</b>, "
    "как только банк сообщит о переводе. Ждать не нужно.\n\n"
    "Чек всё равно пришлите: он нужен нам для сверки, если банк "
    "задержит уведомление или сумма разойдётся на копейку."
    "</blockquote>"
)
