...
# Слушает {{PANEL_DOMAIN}} — сюда входят и панель (panel.домен), и сам домен с www:
# на корневом домене отдаётся публичная витрина с тарифами и кнопкой входа через
# Telegram, то есть человек из поиска попадает на нормальную страницу, а не на
# заглушку nginx. SSL добавляется отдельно
