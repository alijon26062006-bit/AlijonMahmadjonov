...
# Банки для перевода. Имя получателя и номер карты заведение вписывает само
# в админке — пока они пустые, банк клиенту не показывается.
BANKS = [
    {"id": "dc", "name": "Душанбе Сити", "note": "Перевод на карту"},
    {"id": "alif", "name": "Алиф Банк", "note": "Перевод по номеру"},
    {"id": "eskhata", "name": "Банк Эсхата", "note": "Перевод на карту"},
]
