 ...
 *
 * Это обычная ссылка, а не fetch: OAuth — это переход браузера на сайт Google
 * и обратно, и он должен быть настоящей навигацией верхнего уровня.
 *
 * Компонент рисуется только там, где сервер сказал, что провайдер настроен.
 * Кнопки, которая не может сработать, на странице не бывает.
 */
...
/** Официальная четырёхцветная буква G. Единственное цветное пятно на форме. */
function GoogleMark() {
  return (
